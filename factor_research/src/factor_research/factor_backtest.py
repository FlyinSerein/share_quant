...
class FactorResearchRunner:
    def __init__(
        ...
        neutralized_output_dir: Path | None = None,
    ) -> None:
        ...
        self.neutralized_output_dir = Path(neutralized_output_dir) if neutralized_output_dir else self.output_dir / neutralized_subdir
    ...
    def _write_neutralized_outputs(
        ...
        base = self.neutralized_output_dir
        tables = base / "tables"
        images = base / "images"
